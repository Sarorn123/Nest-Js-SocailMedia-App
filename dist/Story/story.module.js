...
const story_scema_1 = require("./story.scema");
...
StoryModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: 'Story', schema: story_scema_1.StorySchema }]),
            user_module_1.UserModule,
        ],
        controllers: [story_controller_1.default],
